...
export default function Dashboard() {
    ...
    <div className="mb-6">
      <div className="relative">
        <input
          ...
          placeholder="Search by position, company, or application ID..."
          value={searchQuery}
  ...
  async function handleSubmit(e) {
    ...
    if (error) {
      ...
      setNewApplication({ company: '', position: '', status: 'applied', referral_name: '', url: '', application_id: '' })
      fetchApplications()
    }
    setLoading(false)
  }
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex gap-4 mb-6">
          {['all', 'applied', 'processing', 'rejected', 'accepted'].map((status) => (
            ...
            >
              ...
              <span className="bg-gray-700/50 px-2 py-0.5 rounded-full text-sm">
                {counts[status]}
              </span>
            </button>
          ))}
        ...
        {/* Show "No results found" message when necessary */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredApplications.map((app) => (
            ...
            >
              ...
              <p className="text-gray-300 mb-2">{app.position}</p>
      ...
      <Dialog open={isModalOpen} onClose={() => setIsModalOpen(false)} className="relative z-50">
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="bg-gray-800 rounded-lg p-6 max-w-sm w-full">
            <Dialog.Title className="text-lg font-medium mb-4">Add New Application</Dialog.Title>
